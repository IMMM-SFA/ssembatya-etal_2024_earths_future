...
for rr in rcp:
    ...
    for mm in model:
        ...
        df_total_load.to_csv("results/"+ rr + "_results/" + rcpmodel + '_load_tot.csv', index=None)
    ...
    df_rcp_peak_hourlyloadseas.to_csv("results/"+ rr +"_results/" +  'rcp_peakseas_tot.csv', index=None)
    ...
    df_rcp_peak_hourlyload.to_csv("results/"+ rr +"_results/" +  'rcp_peakload_tot.csv', index=None)


    #saving rcpall
    df_rcpall.to_csv('results/' + rr + "_results/" + 'rcpall_tot.csv', index=None)
