...
#(left-right ,up-down, horizontal thickness, vertical thickness)

for n in range(len(paths1)):
    df_peak_seas = pd.read_csv(paths1[n]+'/rcp_peakseas_res.csv')
    ...
    ax.set_ylabel(name1[n],fontsize=20, rotation='horizontal',fontweight='bold')
...
fig.tight_layout()
plt.savefig('Figs_manuscript/'+'peaking_res_ssp3_hr.jpg', dpi=1200)   
# #...................................................................................................................
